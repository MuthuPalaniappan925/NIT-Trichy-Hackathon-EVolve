...
def login():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
        ...
        cursor.execute('SELECT * FROM evstations_list WHERE username = % s AND password = % s', (username, password, ))
...
def register():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form :
        ...
        cursor.execute('SELECT * FROM evstations_list WHERE username = % s', (username, ))
        ...
        if account:
            ...
            cursor.execute('INSERT INTO evstations_list VALUES (NULL, % s, % s, % s)', (username, password, email, ))
...
def ev_submission():
    ...
    if request.method == 'POST' and 'address' in request.form and 'c_type' in request.form and 'Price' in request.form:
        print("Here-0")
